...
import com.edu_manger_sys_model.StudentManager;
...
public class searchClassStudent_Tec extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public searchClassStudent_Tec() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<Student> list=manager.queryClassStudents_tec(cla_id);
