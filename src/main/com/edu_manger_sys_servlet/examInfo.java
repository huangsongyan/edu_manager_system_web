...
import com.edu_manger_sys_model.ExamManager;
...
public class examInfo extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int exam_type=Integer.parseInt(request.getParameter("exam_type"));
		List<ExampleInfo> list =examManager.examInfo(stu_id, exam_type);
